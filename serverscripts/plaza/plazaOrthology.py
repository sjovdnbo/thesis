...
outfiledonorsp = open("results_plaza/donorspeciesPlaza.txt","w")
outOrthologyPlaza = open("results_plaza/orthologyPlaza.txt","w")
outInterologyPlaza = open("results_plaza/interologyPlaza.txt",'w')
