class MI_UNIT:
    def __init__(self, string):
        l = string.strip("\n").split("\t")
        if "uniprot" in l[0]:
            self.idInteractorA = l[0].split("uniprotkb")[1].split("_")[0].strip(":")
        else:
            self.idInteractorA = l[0]
        if "uniprot" in l[1]:
            self.idInteractorB = l[1].split("uniprotkb")[1].split("_")[0].strip(":")
        else:
            self.idInteractorB = l[1]
