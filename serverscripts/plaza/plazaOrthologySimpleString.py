...
outfiledonorsp = open("results_plaza_string_simple/donorspeciesPlazaSimpleString.txt","w")
outOrthologyPlaza = open("results_plaza_string_simple/orthologyPlazaSimpleString.txt","w")
outInterologyPlaza = open("results_plaza_string_simple/interologyPlazaSimpleString.txt",'w')
