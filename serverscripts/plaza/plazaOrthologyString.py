...
outfiledonorsp = open("results_plaza_string/donorspeciesPlazaString.txt","w")
outOrthologyPlaza = open("results_plaza_string/orthologyPlazaString.txt","w")
outInterologyPlaza = open("results_plaza_string/interologyPlazaString.txt",'w')
commonOrthologsDict = {}
def iterkeys(values):
    out = []
    for val in values:
