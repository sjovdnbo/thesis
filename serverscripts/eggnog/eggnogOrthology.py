...
outfileortho = open("results_eggnog/orthologyEggnog{}.txt".format(querysp),'w')
outfileintero = open("results_eggnog/interologyEggnog{}.txt".format(querysp),'w')
outfiledonorsp = open("results_eggnog/donorspeciesEggnog{}.txt".format(querysp),'w')
oglist = {}
ptrgenes = set()
        ...
        for i in permute(ptrA,ptrB):
            ...
            if ptr1 != ptr2:
                if (ptr1,ptr2) not in interologs and (ptr2,ptr1) not in interologs:
                    ...
                    donorspmap[(ptr1,ptr2)] = {parseSpnumber(interaction.taxidInteractorA), parseSpnumber(interaction.taxidInteractorB)}
